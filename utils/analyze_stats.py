...
if __name__ == '__main__':
  ...
  # parser.add_argument('--npz', default="../logs/3DLoMatch_UncertainCDSAC_v4_Wilson--UncertainPointDSC_3DMatch_07262014_hard-fcgf.npy", help='path to the npz file')
  parser.add_argument('--npz', default="../logs/SC2_PCR-SVD-fcgf.npy", help='path to the npz file')
  parser.add_argument('--output_postfix', default='test', help='postfix of the output')
